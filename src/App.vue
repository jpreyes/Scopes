...
const { state, fmt, computed, loadHistorial, loadDashboardData, loadClients, loadCatalog } = usePresupuesto()
      ...
      <div class="flex">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="p-3 sm:p-6 no-print">
            ...
            <!-- Dashboard -->
            <Dashboard v-else-if="state.activeSection === 'dashboard'" />

            <!-- Clientes -->
            <Clientes v-else-if="state.activeSection === 'clientes'" />
